...
or newer; Node.js 24.20.0 LTS is recommended. Use "Start Job Matrix.cmd" on
Windows or ./start.sh on macOS/Linux. Optional JobSpy sources require Python
3.10 or newer on PATH; the core application and no-key sources do not.
...
- docs\                       README images and browser-assistant prompt
- licenses\                   bundled-package license texts and metadata
- LICENSE and notices         project and third-party terms
